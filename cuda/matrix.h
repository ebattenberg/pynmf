...
float matrix_difference_norm_d(action_t action,  matrix a, matrix c, const int* params);
float matrix_difference_norm_d(action_t action,  matrix a, matrix c, int block1, int block2, int lapt1, int lapt2);
